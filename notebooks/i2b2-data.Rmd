...
length(unique(annotations_training$text[annotations_training$type == 'PATIENT']))
length(unique(annotations_gold$text[annotations_gold$type == 'PATIENT']))

# Fraction of the unique patient names in the training set that are also in the gold set
length(names_patient_overlap) / length(unique(annotations_training$text[annotations_training$type == 'PATIENT']))
# Fraction of the unique patient names in the gold set that are also in the training set
length(names_patient_overlap) / length(unique(annotations_gold$text[annotations_gold$type == 'PATIENT']))
```
