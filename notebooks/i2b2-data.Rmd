...
length(names_doctor_overlap) / length(unique(annotations_training$name[annotations_training$type == 'DOCTOR']))
length(names_doctor_overlap) / length(unique(annotations_gold$name[annotations_gold$type == 'DOCTOR']))
```
...
length(names_patient_overlap) / length(unique(annotations_training$name[annotations_training$type == 'PATIENT']))
length(names_patient_overlap) / length(unique(annotations_gold$name[annotations_gold$type == 'PATIENT']))
```
